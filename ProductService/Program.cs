...
// Cấu hình AWS S3 với hardcoded credentials
builder.Services.AddSingleton<IAmazonS3>(provider =>
{
    // Lấy credentials từ helper class
    var (accessKey, secretKey) = (AwsConfig.GetAccessKey(), AwsConfig.GetSecretKey());
    var region = RegionEndpoint.GetBySystemName(AwsConfig.GetRegion());
    
    Console.WriteLine($"✅ AWS S3 configured with hardcoded credentials: {accessKey.Substring(0, 4)}****");
