...
namespace Controllers
{
    ...
    public class ShipmentController : ControllerBase
    {
        ...
        public async Task<IActionResult> AssignShipment([FromBody] AssignShipmentRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> GetMyAssignedOrders()
        {
            try
            {
                // TODO: Get shipper ID from JWT token
                var shipperId = 1; // Temporary hardcode
