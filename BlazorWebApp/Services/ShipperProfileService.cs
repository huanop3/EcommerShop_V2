...
namespace BlazorWebApp.Services
{
    public class ShipperProfileService
    {
        ...
        public async Task<List<ShipperProfileVM>?> GetAllShipperProfilesAsync()
        {
            ...
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/GetAllShipperProfiles");
        ...
        {
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/GetShipperProfileById/{shipperId}");
            if (response.IsSuccessStatusCode)
            {
        ...
        {
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/GetShipperProfileByUserId/{userId}");
            if (response.IsSuccessStatusCode)
            {
                var result = await response.Content.ReadFromJsonAsync<HTTPResponseClient<ShipperProfileVM>>();
                if (result?.Success == true && result.Data != null && result.Data.IsDeleted == false)
        ...
        public async Task<bool> CreateShipperProfileAsync(ShipperProfileVM shipperProfile)
        {
            ...
            var response = await _httpClient.PostAsync($"http://localhost:5282/main/api/ShipperProfile/CreateShipperProfile", content);
        ...
        public async Task<bool> UpdateShipperProfileAsync(ShipperProfileVM shipperProfile)
        {
            ...
            var json = JsonSerializer.Serialize(shipperProfile);
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            var response = await _httpClient.PutAsync($"http://localhost:5282/main/api/ShipperProfile/UpdateShipperProfile", content);
            return response.IsSuccessStatusCode;
        }
        ...
        {
            await SetAuthorizationHeader();
            var response = await _httpClient.DeleteAsync($"http://localhost:5282/main/api/ShipperProfile/DeleteShipperProfile/{shipperId}");
            return response.IsSuccessStatusCode;
        }
        ...
        {
            await SetAuthorizationHeader();
            var response = await _httpClient.PutAsync($"http://localhost:5282/main/api/ShipperProfile/ActivateShipperProfile/{shipperId}", null);
            return response.IsSuccessStatusCode;
        }
        ...
        {
            await SetAuthorizationHeader();
            var response = await _httpClient.PutAsync($"http://localhost:5282/main/api/ShipperProfile/DeactivateShipperProfile/{shipperId}", null);
            return response.IsSuccessStatusCode;
        }
        ...
        {
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/GetActiveShipperProfiles");
            if (response.IsSuccessStatusCode)
            {
                var result = await response.Content.ReadFromJsonAsync<HTTPResponseClient<IEnumerable<ShipperProfileVM>>>();
                if (result?.Success == true && result.Data != null)
        ...
        {
            await SetAuthorizationHeader();
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/GetInactiveShipperProfiles");
            if (response.IsSuccessStatusCode)
            {
                var result = await response.Content.ReadFromJsonAsync<HTTPResponseClient<IEnumerable<ShipperProfileVM>>>();
                if (result?.Success == true && result.Data != null)
        ...
        {
            await SetAuthorizationHeader();
            var response = await _httpClient.GetAsync($"http://localhost:5282/main/api/ShipperProfile/CheckUserHasShipperProfile/{userId}");
            if (response.IsSuccessStatusCode)
            {
