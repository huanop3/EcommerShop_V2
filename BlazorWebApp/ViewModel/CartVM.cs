...
public class CartVM
{
    ...
    /// </summary>
    public static void AddToCart(ProductVM product, int quantity = 1)
    {
    ...
    /// </summary>
    public static void AddToCart(int productId, string productName, decimal currentPrice, decimal originalPrice, int quantity)
    {
        var cartItem = new CartVM
        {
            ProductId = productId,
    ...
    /// </summary>
    public static void AddToCart(string productName, decimal currentPrice, decimal originalPrice, int quantity)
    {
        var cartItem = new CartVM
        {
            ProductId = null,
